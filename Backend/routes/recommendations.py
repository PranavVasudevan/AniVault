...
SIMILAR_POOL = {
    "Action": ["Attack on Titan","Demon Slayer","Jujutsu Kaisen","Fullmetal Alchemist Brotherhood"],
    "Slice of Life": ["Barakamon","March Comes in Like a Lion","Natsume Yuujinchou","Violet Evergarden"],
    "Drama": ["Your Lie in April","Clannad After Story","Anohana"],
    "Fantasy": ["Frieren","Made in Abyss","Mushoku Tensei"],
}
...
def recommend_from_favorites(
    ...
    if favorites:
        ...
        recommendations.update(["Attack on Titan","Steins;Gate","Frieren","Your Name","Death Note"])
